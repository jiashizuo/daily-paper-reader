...
score: 7.0
evidence: 多模态MRI脑分区与规范表征
tldr: 现有全脑神经影像框架对深部脑系统（如间脑、脑干）表征不足，限制了健康与疾病中系统级变异的解读。为此，我们开发了MIRATS多尺度框架，整合220个脑区并提取节点、边及拓扑特征，应用于HCP-Aging健康成人数据。结果发现脑干和间脑核团在多尺度上呈现独特特征，且性别和年龄效应具有系统依赖性。该框架为深部调控系统的规范研究提供了定量参考。
source: biorxiv
selection_source: fresh_fetch
motivation: 现有全脑神经影像框架对深部脑系统（如间脑、脑干）表征不足，限制了健康与疾病中系统级变异的解读。
method: 整合脑、小脑、间脑和脑干图谱，构建220区域全脑分割，提取节点属性、边连接和持续同调拓扑特征。
result: 脑干和间脑核团在多尺度上特征异于皮层和小脑；性别差异选择性出现，年龄效应广泛但具有系统和特征依赖性。
conclusion: 规范全脑组织呈现系统特异性模式，该框架为深部调控系统的转化研究提供了定量参考。
---

## 摘要
涉及觉醒、自主调节、感觉整合和稳态控制的深部脑系统在传统的全脑神经影像学框架中仍然代表性不足。特别是，间脑和脑干核团在以皮层为中心的分析中往往没有得到充分体现，这限制了解释健康和疾病中系统级变异所需的规范性参考。为弥补这一空白，我们开发了一个统一的多尺度框架，明确表征深部核团。通过将标准空间中的大脑、小脑、间脑和脑干图谱整合，我们构建了一个包含220个区域的全脑分区，并在三个分析尺度上提取了互补特征：节点属性、边连接性和基于持续同调的拓扑描述符。我们将该框架应用于人类连接组计划-老龄化队列中的健康成年人，以表征规范性的多尺度组织，并测试与性别和年龄相关的变异。应用于该队列时，我们的框架揭示了跨解剖系统的显著异质性。脑干和间脑核团在节点、边连接性和高阶拓扑尺度上显示出与大脑和小脑区域不同的多尺度特征谱。性别比较识别出不同尺度上的选择性差异，而年龄建模则揭示了整个成年期广泛但依赖于特征和系统的变异。总之，这些发现表明，在这个深部系统感知空间中的规范性全脑组织是由系统特异性而非全局统一模式构成的。这些发现建立了一个用于表征健康成年人脑干-间脑-小脑-大脑组织的规范性多尺度框架，并为未来关于深部调节系统中疾病相关异常的转化研究提供了定量参考。
