...
### 2. 核心内容
Modern neuroimaging technologies enable the study of structural connectivity (SC) and functional connectivity (FC) in vivo.
...
### 4. 来源与原文
- Source：ICLR-2026-Public
- OpenReview：[https://openreview.net/forum?id=L3HkIlyfPR](https://openreview.net/forum?id=L3HkIlyfPR)
